...
yad --center --width=250 --height=100 --title="MENU1"  --text "Veuillez choisir : 
		1) Affiche les informations sur les péripheriques de votre  ordinateur :
  	        ...
  	        4) Pour enregistrer :" --button="<b><span color='black'>1</span></b>":1 --button="<b><span color='black'>2</span></b>":2 --button="<b><span color='black'>3</span></b>"!:4 --button="<b><span color='black'>4</span></b>":3 
...
function4()
{
yad --center --width=400 --height=300 --text-info --title="3" --back=black --fore=white<funtion4
...
while [ "$choix" != "0" ]
do
yad --center --width=400 --height=300 --title="Hardware inforamtions" --text="Select.." --image"acceuil.jpg"  \
